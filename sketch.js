...
function preload(){
  jerryImg = loadAnimation("jerryStanding.png","jerry0.png","jerry.png");
  jerryJump = loadAnimation("jerry.png");
  jerrytom = loadAnimation("tomJerry.png");

  tomImg = loadImage("tomStanding.png");
  tomRun = loadImage("tomRunning.png");
  ...
  bgImage = loadImage("bg.avif");
  mainImg = loadImage("start.png");
